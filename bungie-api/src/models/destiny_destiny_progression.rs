...
impl DestinyDestinyProgression {
  /// Information about a current character's status with a Progression. A progression is a value that can increase with activity and has levels. Think Character Level and Reputation Levels. Combine this \"live\" data with the related DestinyProgressionDefinition for a full picture of the Progression.
  pub fn new() -> DestinyDestinyProgression {
  ...
  pub fn with_progression_hash(mut self, progression_hash: i32) -> DestinyDestinyProgression {
    self.progression_hash = Some(progression_hash);
    self
  }
  ...
  pub fn with_daily_progress(mut self, daily_progress: i32) -> DestinyDestinyProgression {
    self.daily_progress = Some(daily_progress);
    self
  }
  ...
  pub fn with_daily_limit(mut self, daily_limit: i32) -> DestinyDestinyProgression {
    self.daily_limit = Some(daily_limit);
    self
  }
  ...
  pub fn with_weekly_progress(mut self, weekly_progress: i32) -> DestinyDestinyProgression {
    self.weekly_progress = Some(weekly_progress);
    self
  }
  ...
  pub fn with_weekly_limit(mut self, weekly_limit: i32) -> DestinyDestinyProgression {
    self.weekly_limit = Some(weekly_limit);
    self
  }
  ...
  pub fn with_current_progress(mut self, current_progress: i32) -> DestinyDestinyProgression {
    self.current_progress = Some(current_progress);
    self
  }
  ...
  pub fn with_level(mut self, level: i32) -> DestinyDestinyProgression {
    self.level = Some(level);
    self
  }
  ...
  pub fn with_level_cap(mut self, level_cap: i32) -> DestinyDestinyProgression {
    self.level_cap = Some(level_cap);
    self
  }
  ...
  pub fn with_step_index(mut self, step_index: i32) -> DestinyDestinyProgression {
    self.step_index = Some(step_index);
    self
  }
  ...
  pub fn with_progress_to_next_level(mut self, progress_to_next_level: i32) -> DestinyDestinyProgression {
    self.progress_to_next_level = Some(progress_to_next_level);
    self
  }
  ...
  pub fn with_next_level_at(mut self, next_level_at: i32) -> DestinyDestinyProgression {
    self.next_level_at = Some(next_level_at);
    self
  }
  ...
  pub fn with_current_reset_count(mut self, current_reset_count: i32) -> DestinyDestinyProgression {
    self.current_reset_count = Some(current_reset_count);
    self
  }
  ...
  pub fn with_season_resets(mut self, season_resets: Vec<::models::DestinyDestinyProgressionResetEntry>) -> DestinyDestinyProgression {
    self.season_resets = Some(season_resets);
    self
  }
  ...
  pub fn with_reward_item_states(mut self, reward_item_states: Vec<i32>) -> DestinyDestinyProgression {
    self.reward_item_states = Some(reward_item_states);
    self
  }
