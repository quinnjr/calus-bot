...
pub struct InlineResponse20047 {
  ...
  response: Option<::models::DestinyResponsesDestinyItemChangeResponse>,
...
impl InlineResponse20047 {
  ...
  pub fn set_response(&mut self, response: ::models::DestinyResponsesDestinyItemChangeResponse) {
    self.response = Some(response);
  }

  pub fn with_response(mut self, response: ::models::DestinyResponsesDestinyItemChangeResponse) -> InlineResponse20047 {
    self.response = Some(response);
    self
  }

  pub fn response(&self) -> Option<&::models::DestinyResponsesDestinyItemChangeResponse> {
  ...
  pub fn with_error_code(mut self, error_code: i32) -> InlineResponse20047 {
    self.error_code = Some(error_code);
    self
  }
  ...
  pub fn with_throttle_seconds(mut self, throttle_seconds: i32) -> InlineResponse20047 {
    self.throttle_seconds = Some(throttle_seconds);
    self
  }
  ...
  pub fn with_error_status(mut self, error_status: String) -> InlineResponse20047 {
    self.error_status = Some(error_status);
    self
  }
  ...
  pub fn with_message(mut self, message: String) -> InlineResponse20047 {
    self.message = Some(message);
    self
  }
  ...
  pub fn with_message_data(mut self, message_data: ::std::collections::HashMap<String, String>) -> InlineResponse20047 {
    self.message_data = Some(message_data);
    self
  }
  ...
  pub fn with_detailed_error_trace(mut self, detailed_error_trace: String) -> InlineResponse20047 {
    self.detailed_error_trace = Some(detailed_error_trace);
    self
  }
