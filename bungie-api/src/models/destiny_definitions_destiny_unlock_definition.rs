...
pub struct DestinyDefinitionsDestinyUnlockDefinition {
...
impl DestinyDefinitionsDestinyUnlockDefinition {
  ...
  pub fn new() -> DestinyDefinitionsDestinyUnlockDefinition {
  ...
  pub fn with_display_properties(mut self, display_properties: Value) -> DestinyDefinitionsDestinyUnlockDefinition {
    self.display_properties = Some(display_properties);
    self
  }
  ...
  pub fn with_hash(mut self, hash: i32) -> DestinyDefinitionsDestinyUnlockDefinition {
    self.hash = Some(hash);
    self
  }
  ...
  pub fn with_index(mut self, index: i32) -> DestinyDefinitionsDestinyUnlockDefinition {
    self.index = Some(index);
    self
  }
  ...
  pub fn with_redacted(mut self, redacted: bool) -> DestinyDefinitionsDestinyUnlockDefinition {
    self.redacted = Some(redacted);
    self
  }
