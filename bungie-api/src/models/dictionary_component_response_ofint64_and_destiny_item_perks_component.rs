...
impl DictionaryComponentResponseOfint64AndDestinyItemPerksComponent {
  ...
  pub fn with_data(mut self, data: ::std::collections::HashMap<String, ::models::DestinyEntitiesItemsDestinyItemPerksComponent>) -> DictionaryComponentResponseOfint64AndDestinyItemPerksComponent {
    self.data = Some(data);
    self
  }
  ...
  pub fn with_privacy(mut self, privacy: i32) -> DictionaryComponentResponseOfint64AndDestinyItemPerksComponent {
    self.privacy = Some(privacy);
    self
  }
  ...
  pub fn with_disabled(mut self, disabled: bool) -> DictionaryComponentResponseOfint64AndDestinyItemPerksComponent {
    self.disabled = Some(disabled);
    self
  }
