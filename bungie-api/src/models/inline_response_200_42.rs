...
pub struct InlineResponse20042 {
  ...
  response: Option<::models::DestinyResponsesDestinyVendorsResponse>,
...
impl InlineResponse20042 {
  ...
  pub fn set_response(&mut self, response: ::models::DestinyResponsesDestinyVendorsResponse) {
    self.response = Some(response);
  }

  pub fn with_response(mut self, response: ::models::DestinyResponsesDestinyVendorsResponse) -> InlineResponse20042 {
    self.response = Some(response);
    self
  }

  pub fn response(&self) -> Option<&::models::DestinyResponsesDestinyVendorsResponse> {
  ...
  pub fn with_error_code(mut self, error_code: i32) -> InlineResponse20042 {
    self.error_code = Some(error_code);
    self
  }
  ...
  pub fn with_throttle_seconds(mut self, throttle_seconds: i32) -> InlineResponse20042 {
    self.throttle_seconds = Some(throttle_seconds);
    self
  }
  ...
  pub fn with_error_status(mut self, error_status: String) -> InlineResponse20042 {
    self.error_status = Some(error_status);
    self
  }
  ...
  pub fn with_message(mut self, message: String) -> InlineResponse20042 {
    self.message = Some(message);
    self
  }
  ...
  pub fn with_message_data(mut self, message_data: ::std::collections::HashMap<String, String>) -> InlineResponse20042 {
    self.message_data = Some(message_data);
    self
  }
  ...
  pub fn with_detailed_error_trace(mut self, detailed_error_trace: String) -> InlineResponse20042 {
    self.detailed_error_trace = Some(detailed_error_trace);
    self
  }
