...
pub struct GroupsV2GroupMembershipSearchResponse {
...
impl GroupsV2GroupMembershipSearchResponse {
  pub fn new() -> GroupsV2GroupMembershipSearchResponse {
  ...
  pub fn with_results(mut self, results: Vec<::models::GroupsV2GroupMembership>) -> GroupsV2GroupMembershipSearchResponse {
    self.results = Some(results);
    self
  }
  ...
  pub fn with_total_results(mut self, total_results: i32) -> GroupsV2GroupMembershipSearchResponse {
    self.total_results = Some(total_results);
    self
  }
  ...
  pub fn with_has_more(mut self, has_more: bool) -> GroupsV2GroupMembershipSearchResponse {
    self.has_more = Some(has_more);
    self
  }
  ...
  pub fn with_query(mut self, query: ::models::QueriesPagedQuery) -> GroupsV2GroupMembershipSearchResponse {
    self.query = Some(query);
    self
  }
  ...
  pub fn with_replacement_continuation_token(mut self, replacement_continuation_token: String) -> GroupsV2GroupMembershipSearchResponse {
    self.replacement_continuation_token = Some(replacement_continuation_token);
    self
  }
  ...
  pub fn with_use_total_results(mut self, use_total_results: bool) -> GroupsV2GroupMembershipSearchResponse {
    self.use_total_results = Some(use_total_results);
    self
  }
