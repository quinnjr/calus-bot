...
pub struct SearchResultOfGroupMember {
  ...
  results: Option<Vec<::models::GroupsV2GroupMember>>,
...
impl SearchResultOfGroupMember {
  ...
  pub fn set_results(&mut self, results: Vec<::models::GroupsV2GroupMember>) {
    self.results = Some(results);
  }

  pub fn with_results(mut self, results: Vec<::models::GroupsV2GroupMember>) -> SearchResultOfGroupMember {
    self.results = Some(results);
    self
  }

  pub fn results(&self) -> Option<&Vec<::models::GroupsV2GroupMember>> {
    self.results.as_ref()
  }
  ...
  pub fn with_total_results(mut self, total_results: i32) -> SearchResultOfGroupMember {
    self.total_results = Some(total_results);
    self
  }
  ...
  pub fn with_has_more(mut self, has_more: bool) -> SearchResultOfGroupMember {
    self.has_more = Some(has_more);
    self
  }
  ...
  pub fn with_query(mut self, query: ::models::QueriesPagedQuery) -> SearchResultOfGroupMember {
    self.query = Some(query);
    self
  }
  ...
  pub fn with_replacement_continuation_token(mut self, replacement_continuation_token: String) -> SearchResultOfGroupMember {
    self.replacement_continuation_token = Some(replacement_continuation_token);
    self
  }
  ...
  pub fn with_use_total_results(mut self, use_total_results: bool) -> SearchResultOfGroupMember {
    self.use_total_results = Some(use_total_results);
    self
  }
