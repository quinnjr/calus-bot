...
pub struct GroupsV2GroupPotentialMembershipSearchResponse {
  #[serde(rename = "results")]
  results: Option<Vec<::models::GroupsV2GroupPotentialMembership>>,
...
impl GroupsV2GroupPotentialMembershipSearchResponse {
  pub fn new() -> GroupsV2GroupPotentialMembershipSearchResponse {
  ...
  pub fn set_results(&mut self, results: Vec<::models::GroupsV2GroupPotentialMembership>) {
    self.results = Some(results);
  }

  pub fn with_results(mut self, results: Vec<::models::GroupsV2GroupPotentialMembership>) -> GroupsV2GroupPotentialMembershipSearchResponse {
    self.results = Some(results);
    self
  }

  pub fn results(&self) -> Option<&Vec<::models::GroupsV2GroupPotentialMembership>> {
    self.results.as_ref()
  }
  ...
  pub fn with_total_results(mut self, total_results: i32) -> GroupsV2GroupPotentialMembershipSearchResponse {
    self.total_results = Some(total_results);
    self
  }
  ...
  pub fn with_has_more(mut self, has_more: bool) -> GroupsV2GroupPotentialMembershipSearchResponse {
    self.has_more = Some(has_more);
    self
  }
  ...
  pub fn with_query(mut self, query: ::models::QueriesPagedQuery) -> GroupsV2GroupPotentialMembershipSearchResponse {
    self.query = Some(query);
    self
  }
  ...
  pub fn with_replacement_continuation_token(mut self, replacement_continuation_token: String) -> GroupsV2GroupPotentialMembershipSearchResponse {
    self.replacement_continuation_token = Some(replacement_continuation_token);
    self
  }
  ...
  pub fn with_use_total_results(mut self, use_total_results: bool) -> GroupsV2GroupPotentialMembershipSearchResponse {
    self.use_total_results = Some(use_total_results);
    self
  }
