...
impl UserUserInfoCard {
  ...
  pub fn with_cross_save_override(mut self, cross_save_override: i32) -> UserUserInfoCard {
    self.cross_save_override = Some(cross_save_override);
    self
  }
  ...
  pub fn with_applicable_membership_types(mut self, applicable_membership_types: Vec<i32>) -> UserUserInfoCard {
    self.applicable_membership_types = Some(applicable_membership_types);
    self
  }
  ...
  pub fn with_is_public(mut self, is_public: bool) -> UserUserInfoCard {
    self.is_public = Some(is_public);
    self
  }
  ...
  pub fn with_membership_type(mut self, membership_type: i32) -> UserUserInfoCard {
    self.membership_type = Some(membership_type);
    self
  }
