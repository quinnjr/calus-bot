...
pub struct InlineResponse20021 {
  ...
  response: Option<::models::GroupsV2GroupResponse>,
...
impl InlineResponse20021 {
  ...
  pub fn set_response(&mut self, response: ::models::GroupsV2GroupResponse) {
    self.response = Some(response);
  }

  pub fn with_response(mut self, response: ::models::GroupsV2GroupResponse) -> InlineResponse20021 {
    self.response = Some(response);
    self
  }

  pub fn response(&self) -> Option<&::models::GroupsV2GroupResponse> {
  ...
  pub fn with_error_code(mut self, error_code: i32) -> InlineResponse20021 {
    self.error_code = Some(error_code);
    self
  }
  ...
  pub fn with_detailed_error_trace(mut self, detailed_error_trace: String) -> InlineResponse20021 {
    self.detailed_error_trace = Some(detailed_error_trace);
    self
  }
