...
pub struct QueriesSearchResult {
...
impl QueriesSearchResult {
  pub fn new() -> QueriesSearchResult {
    QueriesSearchResult {
      total_results: None,
      has_more: None,
      query: None,
  ...
  pub fn with_total_results(mut self, total_results: i32) -> QueriesSearchResult {
    self.total_results = Some(total_results);
    self
  }
  ...
  pub fn with_has_more(mut self, has_more: bool) -> QueriesSearchResult {
    self.has_more = Some(has_more);
    self
  }
  ...
  pub fn with_query(mut self, query: ::models::QueriesPagedQuery) -> QueriesSearchResult {
    self.query = Some(query);
    self
  }
  ...
  pub fn with_replacement_continuation_token(mut self, replacement_continuation_token: String) -> QueriesSearchResult {
    self.replacement_continuation_token = Some(replacement_continuation_token);
    self
  }
  ...
  pub fn with_use_total_results(mut self, use_total_results: bool) -> QueriesSearchResult {
    self.use_total_results = Some(use_total_results);
    self
  }
