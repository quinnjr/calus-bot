...
pub struct InlineResponse2006 {
  ...
  response: Option<Vec<::models::PartnershipsPublicPartnershipDetail>>,
...
impl InlineResponse2006 {
  ...
  pub fn set_response(&mut self, response: Vec<::models::PartnershipsPublicPartnershipDetail>) {
    self.response = Some(response);
  }

  pub fn with_response(mut self, response: Vec<::models::PartnershipsPublicPartnershipDetail>) -> InlineResponse2006 {
    self.response = Some(response);
    self
  }

  pub fn response(&self) -> Option<&Vec<::models::PartnershipsPublicPartnershipDetail>> {
  ...
  pub fn with_error_code(mut self, error_code: i32) -> InlineResponse2006 {
    self.error_code = Some(error_code);
    self
  }
  ...
  pub fn with_throttle_seconds(mut self, throttle_seconds: i32) -> InlineResponse2006 {
    self.throttle_seconds = Some(throttle_seconds);
    self
  }
  ...
  pub fn with_error_status(mut self, error_status: String) -> InlineResponse2006 {
    self.error_status = Some(error_status);
    self
  }
  ...
  pub fn with_message(mut self, message: String) -> InlineResponse2006 {
    self.message = Some(message);
    self
  }
  ...
  pub fn with_message_data(mut self, message_data: ::std::collections::HashMap<String, String>) -> InlineResponse2006 {
    self.message_data = Some(message_data);
    self
  }
  ...
  pub fn with_detailed_error_trace(mut self, detailed_error_trace: String) -> InlineResponse2006 {
    self.detailed_error_trace = Some(detailed_error_trace);
    self
  }
