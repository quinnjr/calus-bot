...
impl DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent {
  /// The base class for Vendor Sale Item data. Has a bunch of character-agnostic state about the item being sold.  Note that if you want instance, stats, etc... data for the item, you'll have to request additional components such as ItemInstances, ItemPerks etc... and acquire them from the DestinyVendorResponse's \"items\" property.
  pub fn new() -> DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent {
    DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent {
  ...
  pub fn with_vendor_item_index(mut self, vendor_item_index: i32) -> DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent {
    self.vendor_item_index = Some(vendor_item_index);
    self
  }
  ...
  pub fn with_item_hash(mut self, item_hash: i32) -> DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent {
    self.item_hash = Some(item_hash);
    self
  }
  ...
  pub fn with_override_style_item_hash(mut self, override_style_item_hash: i32) -> DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent {
    self.override_style_item_hash = Some(override_style_item_hash);
    self
  }
  ...
  pub fn with_quantity(mut self, quantity: i32) -> DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent {
    self.quantity = Some(quantity);
    self
  }
  ...
  pub fn with_costs(mut self, costs: Vec<::models::DestinyDestinyItemQuantity>) -> DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent {
    self.costs = Some(costs);
    self
  }
  ...
  pub fn with_override_next_refresh_date(mut self, override_next_refresh_date: String) -> DestinyComponentsVendorsDestinyVendorSaleItemBaseComponent {
    self.override_next_refresh_date = Some(override_next_refresh_date);
    self
  }
