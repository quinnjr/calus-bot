...
pub struct SearchResultOfGroupMemberApplication {
  ...
  results: Option<Vec<::models::GroupsV2GroupMemberApplication>>,
...
impl SearchResultOfGroupMemberApplication {
  ...
  pub fn set_results(&mut self, results: Vec<::models::GroupsV2GroupMemberApplication>) {
    self.results = Some(results);
  }

  pub fn with_results(mut self, results: Vec<::models::GroupsV2GroupMemberApplication>) -> SearchResultOfGroupMemberApplication {
    self.results = Some(results);
    self
  }

  pub fn results(&self) -> Option<&Vec<::models::GroupsV2GroupMemberApplication>> {
    self.results.as_ref()
  }
  ...
  pub fn with_total_results(mut self, total_results: i32) -> SearchResultOfGroupMemberApplication {
    self.total_results = Some(total_results);
    self
  }
  ...
  pub fn with_has_more(mut self, has_more: bool) -> SearchResultOfGroupMemberApplication {
    self.has_more = Some(has_more);
    self
  }
  ...
  pub fn with_query(mut self, query: ::models::QueriesPagedQuery) -> SearchResultOfGroupMemberApplication {
    self.query = Some(query);
    self
  }
  ...
  pub fn with_replacement_continuation_token(mut self, replacement_continuation_token: String) -> SearchResultOfGroupMemberApplication {
    self.replacement_continuation_token = Some(replacement_continuation_token);
    self
  }
  ...
  pub fn with_use_total_results(mut self, use_total_results: bool) -> SearchResultOfGroupMemberApplication {
    self.use_total_results = Some(use_total_results);
    self
  }
