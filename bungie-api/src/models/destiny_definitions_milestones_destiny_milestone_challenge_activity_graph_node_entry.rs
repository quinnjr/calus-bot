...
pub struct DestinyDefinitionsMilestonesDestinyMilestoneChallengeActivityGraphNodeEntry {
...
impl DestinyDefinitionsMilestonesDestinyMilestoneChallengeActivityGraphNodeEntry {
  pub fn new() -> DestinyDefinitionsMilestonesDestinyMilestoneChallengeActivityGraphNodeEntry {
  ...
  pub fn with_activity_graph_hash(mut self, activity_graph_hash: i32) -> DestinyDefinitionsMilestonesDestinyMilestoneChallengeActivityGraphNodeEntry {
    self.activity_graph_hash = Some(activity_graph_hash);
    self
  }
  ...
  pub fn with_activity_graph_node_hash(mut self, activity_graph_node_hash: i32) -> DestinyDefinitionsMilestonesDestinyMilestoneChallengeActivityGraphNodeEntry {
    self.activity_graph_node_hash = Some(activity_graph_node_hash);
    self
  }
