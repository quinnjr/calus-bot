...
impl SingleComponentResponseOfDestinyItemStatsComponent {
  ...
  pub fn with_privacy(mut self, privacy: i32) -> SingleComponentResponseOfDestinyItemStatsComponent {
    self.privacy = Some(privacy);
    self
  }
  ...
  pub fn with_disabled(mut self, disabled: bool) -> SingleComponentResponseOfDestinyItemStatsComponent {
    self.disabled = Some(disabled);
    self
  }
