...
pub struct SearchResultOfContentItemPublicContract {
  ...
  results: Option<Vec<::models::ContentContentItemPublicContract>>,
...
impl SearchResultOfContentItemPublicContract {
  ...
  pub fn set_results(&mut self, results: Vec<::models::ContentContentItemPublicContract>) {
    self.results = Some(results);
  }

  pub fn with_results(mut self, results: Vec<::models::ContentContentItemPublicContract>) -> SearchResultOfContentItemPublicContract {
    self.results = Some(results);
    self
  }

  pub fn results(&self) -> Option<&Vec<::models::ContentContentItemPublicContract>> {
    self.results.as_ref()
  }
  ...
  pub fn with_total_results(mut self, total_results: i32) -> SearchResultOfContentItemPublicContract {
    self.total_results = Some(total_results);
    self
  }
  ...
  pub fn with_has_more(mut self, has_more: bool) -> SearchResultOfContentItemPublicContract {
    self.has_more = Some(has_more);
    self
  }
  ...
  pub fn with_query(mut self, query: ::models::QueriesPagedQuery) -> SearchResultOfContentItemPublicContract {
    self.query = Some(query);
    self
  }
  ...
  pub fn with_replacement_continuation_token(mut self, replacement_continuation_token: String) -> SearchResultOfContentItemPublicContract {
    self.replacement_continuation_token = Some(replacement_continuation_token);
    self
  }
  ...
  pub fn with_use_total_results(mut self, use_total_results: bool) -> SearchResultOfContentItemPublicContract {
    self.use_total_results = Some(use_total_results);
    self
  }
