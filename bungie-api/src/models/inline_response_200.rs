...
pub struct InlineResponse200 {
  ...
  response: Option<::models::ApplicationsApiUsage>,
...
impl InlineResponse200 {
  ...
  pub fn set_response(&mut self, response: ::models::ApplicationsApiUsage) {
    self.response = Some(response);
  }

  pub fn with_response(mut self, response: ::models::ApplicationsApiUsage) -> InlineResponse200 {
    self.response = Some(response);
    self
  }

  pub fn response(&self) -> Option<&::models::ApplicationsApiUsage> {
  ...
  pub fn with_error_code(mut self, error_code: i32) -> InlineResponse200 {
    self.error_code = Some(error_code);
    self
  }
  ...
  pub fn with_throttle_seconds(mut self, throttle_seconds: i32) -> InlineResponse200 {
    self.throttle_seconds = Some(throttle_seconds);
    self
  }
  ...
  pub fn with_error_status(mut self, error_status: String) -> InlineResponse200 {
    self.error_status = Some(error_status);
    self
  }
  ...
  pub fn with_message_data(mut self, message_data: ::std::collections::HashMap<String, String>) -> InlineResponse200 {
    self.message_data = Some(message_data);
    self
  }
  ...
  pub fn with_detailed_error_trace(mut self, detailed_error_trace: String) -> InlineResponse200 {
    self.detailed_error_trace = Some(detailed_error_trace);
    self
  }
