...
pub struct DestinyMilestonesDestinyMilestoneVendor {
...
impl DestinyMilestonesDestinyMilestoneVendor {
  ...
  pub fn new() -> DestinyMilestonesDestinyMilestoneVendor {
  ...
  pub fn with_vendor_hash(mut self, vendor_hash: i32) -> DestinyMilestonesDestinyMilestoneVendor {
    self.vendor_hash = Some(vendor_hash);
    self
  }
  ...
  pub fn with_preview_item_hash(mut self, preview_item_hash: i32) -> DestinyMilestonesDestinyMilestoneVendor {
    self.preview_item_hash = Some(preview_item_hash);
    self
  }
