...
impl SingleComponentResponseOfDestinyCharacterActivitiesComponent {
  ...
  pub fn with_privacy(mut self, privacy: i32) -> SingleComponentResponseOfDestinyCharacterActivitiesComponent {
    self.privacy = Some(privacy);
    self
  }
  ...
  pub fn with_disabled(mut self, disabled: bool) -> SingleComponentResponseOfDestinyCharacterActivitiesComponent {
    self.disabled = Some(disabled);
    self
  }
