...
pub struct SearchResultOfDestinyEntitySearchResultItem {
  ...
  results: Option<Vec<::models::DestinyDefinitionsDestinyEntitySearchResultItem>>,
...
impl SearchResultOfDestinyEntitySearchResultItem {
  ...
  pub fn set_results(&mut self, results: Vec<::models::DestinyDefinitionsDestinyEntitySearchResultItem>) {
    self.results = Some(results);
  }

  pub fn with_results(mut self, results: Vec<::models::DestinyDefinitionsDestinyEntitySearchResultItem>) -> SearchResultOfDestinyEntitySearchResultItem {
    self.results = Some(results);
    self
  }

  pub fn results(&self) -> Option<&Vec<::models::DestinyDefinitionsDestinyEntitySearchResultItem>> {
    self.results.as_ref()
  }
  ...
  pub fn with_total_results(mut self, total_results: i32) -> SearchResultOfDestinyEntitySearchResultItem {
    self.total_results = Some(total_results);
    self
  }
  ...
  pub fn with_has_more(mut self, has_more: bool) -> SearchResultOfDestinyEntitySearchResultItem {
    self.has_more = Some(has_more);
    self
  }
  ...
  pub fn with_query(mut self, query: ::models::QueriesPagedQuery) -> SearchResultOfDestinyEntitySearchResultItem {
    self.query = Some(query);
    self
  }
  ...
  pub fn with_replacement_continuation_token(mut self, replacement_continuation_token: String) -> SearchResultOfDestinyEntitySearchResultItem {
    self.replacement_continuation_token = Some(replacement_continuation_token);
    self
  }
  ...
  pub fn with_use_total_results(mut self, use_total_results: bool) -> SearchResultOfDestinyEntitySearchResultItem {
    self.use_total_results = Some(use_total_results);
    self
  }
