...
pub struct DestinyItemComponentSetOfint32 {
  ...
  reusable_plugs: Option<::models::DictionaryComponentResponseOfint32AndDestinyItemReusablePlugsComponent>,
  #[serde(rename = "plugObjectives")]
  plug_objectives: Option<::models::DictionaryComponentResponseOfint32AndDestinyItemPlugObjectivesComponent>,
...
impl DestinyItemComponentSetOfint32 {
  ...
  pub fn set_reusable_plugs(&mut self, reusable_plugs: ::models::DictionaryComponentResponseOfint32AndDestinyItemReusablePlugsComponent) {
    self.reusable_plugs = Some(reusable_plugs);
  }

  pub fn with_reusable_plugs(mut self, reusable_plugs: ::models::DictionaryComponentResponseOfint32AndDestinyItemReusablePlugsComponent) -> DestinyItemComponentSetOfint32 {
    self.reusable_plugs = Some(reusable_plugs);
    self
  }

  pub fn reusable_plugs(&self) -> Option<&::models::DictionaryComponentResponseOfint32AndDestinyItemReusablePlugsComponent> {
  ...
  pub fn set_plug_objectives(&mut self, plug_objectives: ::models::DictionaryComponentResponseOfint32AndDestinyItemPlugObjectivesComponent) {
    self.plug_objectives = Some(plug_objectives);
  }

  pub fn with_plug_objectives(mut self, plug_objectives: ::models::DictionaryComponentResponseOfint32AndDestinyItemPlugObjectivesComponent) -> DestinyItemComponentSetOfint32 {
    self.plug_objectives = Some(plug_objectives);
    self
  }

  pub fn plug_objectives(&self) -> Option<&::models::DictionaryComponentResponseOfint32AndDestinyItemPlugObjectivesComponent> {
