...
/// DestinyDefinitionsDestinyProgressionMappingDefinition : Aggregations of multiple progressions.  These are used to apply rewards to multiple progressions at once. They can sometimes have human readable data as well, but only extremely sporadically.

#[allow(unused_imports)]
use serde_json::Value;

#[derive(Debug, Serialize, Deserialize)]
pub struct DestinyDefinitionsDestinyProgressionMappingDefinition {
...
impl DestinyDefinitionsDestinyProgressionMappingDefinition {
  ...
  pub fn new() -> DestinyDefinitionsDestinyProgressionMappingDefinition {
  ...
  pub fn with_display_properties(mut self, display_properties: Value) -> DestinyDefinitionsDestinyProgressionMappingDefinition {
    self.display_properties = Some(display_properties);
    self
  }
  ...
  pub fn set_display_units(&mut self, display_units: String) {
    self.display_units = Some(display_units);
  }

  pub fn with_display_units(mut self, display_units: String) -> DestinyDefinitionsDestinyProgressionMappingDefinition {
    self.display_units = Some(display_units);
    self
  }
  ...
  pub fn reset_display_units(&mut self) {
  ...
  pub fn with_hash(mut self, hash: i32) -> DestinyDefinitionsDestinyProgressionMappingDefinition {
    self.hash = Some(hash);
    self
  }
  ...
  pub fn with_index(mut self, index: i32) -> DestinyDefinitionsDestinyProgressionMappingDefinition {
    self.index = Some(index);
    self
  }
  ...
  pub fn with_redacted(mut self, redacted: bool) -> DestinyDefinitionsDestinyProgressionMappingDefinition {
    self.redacted = Some(redacted);
    self
  }
