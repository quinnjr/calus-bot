...
pub struct InlineResponse20022 {
  ...
  response: Option<Vec<::models::GroupsV2GroupOptionalConversation>>,
...
impl InlineResponse20022 {
  ...
  pub fn set_response(&mut self, response: Vec<::models::GroupsV2GroupOptionalConversation>) {
    self.response = Some(response);
  }

  pub fn with_response(mut self, response: Vec<::models::GroupsV2GroupOptionalConversation>) -> InlineResponse20022 {
    self.response = Some(response);
    self
  }

  pub fn response(&self) -> Option<&Vec<::models::GroupsV2GroupOptionalConversation>> {
  ...
  pub fn with_error_code(mut self, error_code: i32) -> InlineResponse20022 {
    self.error_code = Some(error_code);
    self
  }
  ...
  pub fn with_detailed_error_trace(mut self, detailed_error_trace: String) -> InlineResponse20022 {
    self.detailed_error_trace = Some(detailed_error_trace);
    self
  }
