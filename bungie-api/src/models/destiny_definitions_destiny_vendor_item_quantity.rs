...
/// DestinyDefinitionsDestinyVendorItemQuantity : In addition to item quantity information for vendor prices, this also has any optional information that may exist about how the item's quantity can be modified. (unfortunately not information that is able to be read outside of the BNet servers, but it's there)
...
impl DestinyDefinitionsDestinyVendorItemQuantity {
  ...
  pub fn new() -> DestinyDefinitionsDestinyVendorItemQuantity {
  ...
  pub fn with_item_hash(mut self, item_hash: i32) -> DestinyDefinitionsDestinyVendorItemQuantity {
    self.item_hash = Some(item_hash);
    self
  }
  ...
  pub fn with_item_instance_id(mut self, item_instance_id: i64) -> DestinyDefinitionsDestinyVendorItemQuantity {
    self.item_instance_id = Some(item_instance_id);
    self
  }
  ...
  pub fn with_quantity(mut self, quantity: i32) -> DestinyDefinitionsDestinyVendorItemQuantity {
    self.quantity = Some(quantity);
    self
  }
