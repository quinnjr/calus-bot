...
impl SearchResultOfGroupV2Card {
  ...
  pub fn with_results(mut self, results: Vec<::models::GroupsV2GroupV2Card>) -> SearchResultOfGroupV2Card {
    self.results = Some(results);
    self
  }
  ...
  pub fn with_total_results(mut self, total_results: i32) -> SearchResultOfGroupV2Card {
    self.total_results = Some(total_results);
    self
  }
  ...
  pub fn with_has_more(mut self, has_more: bool) -> SearchResultOfGroupV2Card {
    self.has_more = Some(has_more);
    self
  }
  ...
  pub fn with_query(mut self, query: ::models::QueriesPagedQuery) -> SearchResultOfGroupV2Card {
    self.query = Some(query);
    self
  }
  ...
  pub fn with_replacement_continuation_token(mut self, replacement_continuation_token: String) -> SearchResultOfGroupV2Card {
    self.replacement_continuation_token = Some(replacement_continuation_token);
    self
  }
  ...
  pub fn with_use_total_results(mut self, use_total_results: bool) -> SearchResultOfGroupV2Card {
    self.use_total_results = Some(use_total_results);
    self
  }
