...
pub struct DestinySocketsDestinyItemPlug {
...
impl DestinySocketsDestinyItemPlug {
  pub fn new() -> DestinySocketsDestinyItemPlug {
  ...
  pub fn with_plug_objectives(mut self, plug_objectives: Vec<::models::DestinyQuestsDestinyObjectiveProgress>) -> DestinySocketsDestinyItemPlug {
    self.plug_objectives = Some(plug_objectives);
    self
  }
  ...
  pub fn with_plug_item_hash(mut self, plug_item_hash: i32) -> DestinySocketsDestinyItemPlug {
    self.plug_item_hash = Some(plug_item_hash);
    self
  }
  ...
  pub fn with_can_insert(mut self, can_insert: bool) -> DestinySocketsDestinyItemPlug {
    self.can_insert = Some(can_insert);
    self
  }
  ...
  pub fn with_enabled(mut self, enabled: bool) -> DestinySocketsDestinyItemPlug {
    self.enabled = Some(enabled);
    self
  }
  ...
  pub fn with_insert_fail_indexes(mut self, insert_fail_indexes: Vec<i32>) -> DestinySocketsDestinyItemPlug {
    self.insert_fail_indexes = Some(insert_fail_indexes);
    self
  }
  ...
  pub fn with_enable_fail_indexes(mut self, enable_fail_indexes: Vec<i32>) -> DestinySocketsDestinyItemPlug {
    self.enable_fail_indexes = Some(enable_fail_indexes);
    self
  }
