...
impl SingleComponentResponseOfDestinyKiosksComponent {
  ...
  pub fn with_privacy(mut self, privacy: i32) -> SingleComponentResponseOfDestinyKiosksComponent {
    self.privacy = Some(privacy);
    self
  }
  ...
  pub fn with_disabled(mut self, disabled: bool) -> SingleComponentResponseOfDestinyKiosksComponent {
    self.disabled = Some(disabled);
    self
  }
