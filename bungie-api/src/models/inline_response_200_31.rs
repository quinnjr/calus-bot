...
pub struct InlineResponse20031 {
  ...
  response: Option<::models::GroupsV2GroupPotentialMembershipSearchResponse>,
...
impl InlineResponse20031 {
  ...
  pub fn set_response(&mut self, response: ::models::GroupsV2GroupPotentialMembershipSearchResponse) {
    self.response = Some(response);
  }

  pub fn with_response(mut self, response: ::models::GroupsV2GroupPotentialMembershipSearchResponse) -> InlineResponse20031 {
    self.response = Some(response);
    self
  }

  pub fn response(&self) -> Option<&::models::GroupsV2GroupPotentialMembershipSearchResponse> {
  ...
  pub fn with_error_code(mut self, error_code: i32) -> InlineResponse20031 {
    self.error_code = Some(error_code);
    self
  }
  ...
  pub fn with_throttle_seconds(mut self, throttle_seconds: i32) -> InlineResponse20031 {
    self.throttle_seconds = Some(throttle_seconds);
    self
  }
  ...
  pub fn with_error_status(mut self, error_status: String) -> InlineResponse20031 {
    self.error_status = Some(error_status);
    self
  }
  ...
  pub fn with_message(mut self, message: String) -> InlineResponse20031 {
    self.message = Some(message);
    self
  }
  ...
  pub fn with_message_data(mut self, message_data: ::std::collections::HashMap<String, String>) -> InlineResponse20031 {
    self.message_data = Some(message_data);
    self
  }
  ...
  pub fn with_detailed_error_trace(mut self, detailed_error_trace: String) -> InlineResponse20031 {
    self.detailed_error_trace = Some(detailed_error_trace);
    self
  }
