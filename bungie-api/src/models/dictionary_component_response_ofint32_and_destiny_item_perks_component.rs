...
impl DictionaryComponentResponseOfint32AndDestinyItemPerksComponent {
  ...
  pub fn with_data(mut self, data: ::std::collections::HashMap<String, ::models::DestinyEntitiesItemsDestinyItemPerksComponent>) -> DictionaryComponentResponseOfint32AndDestinyItemPerksComponent {
    self.data = Some(data);
    self
  }
  ...
  pub fn with_privacy(mut self, privacy: i32) -> DictionaryComponentResponseOfint32AndDestinyItemPerksComponent {
    self.privacy = Some(privacy);
    self
  }
  ...
  pub fn with_disabled(mut self, disabled: bool) -> DictionaryComponentResponseOfint32AndDestinyItemPerksComponent {
    self.disabled = Some(disabled);
    self
  }
