...
impl DestinyDefinitionsDestinyPlaceDefinition {
  ...
  pub fn new() -> DestinyDefinitionsDestinyPlaceDefinition {
  ...
  pub fn with_display_properties(mut self, display_properties: ::models::DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition) -> DestinyDefinitionsDestinyPlaceDefinition {
    self.display_properties = Some(display_properties);
    self
  }
  ...
  pub fn with_hash(mut self, hash: i32) -> DestinyDefinitionsDestinyPlaceDefinition {
    self.hash = Some(hash);
    self
  }
  ...
  pub fn with_index(mut self, index: i32) -> DestinyDefinitionsDestinyPlaceDefinition {
    self.index = Some(index);
    self
  }
  ...
  pub fn with_redacted(mut self, redacted: bool) -> DestinyDefinitionsDestinyPlaceDefinition {
    self.redacted = Some(redacted);
    self
  }
