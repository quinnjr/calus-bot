...
**enum_value** | **i32** | We have an enumeration for Breaker types for quick reference. This is the current definition&#39;s breaker type enum value. | [optional] [default to null]
