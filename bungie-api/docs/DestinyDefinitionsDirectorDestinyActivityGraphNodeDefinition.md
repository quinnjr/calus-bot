...
**override_display** | [***Value**](Value.md) | The node *may* have display properties that override the active Activity&#39;s display properties. | [optional] [default to null]
**position** | [***Value**](Value.md) | The position on the map for this node. | [optional] [default to null]
